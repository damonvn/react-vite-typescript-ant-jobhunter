...
import { callCreateSubscriber, callFetchAllSkill, callFetchResumeByUser, callGetSubscriberSkills, callUpdateSubscriber } from "@/configs/api";
import type { ColumnsType } from 'antd/es/table';
import dayjs from 'dayjs';
import { MonitorOutlined } from "@ant-design/icons";
import { SKILLS_LIST } from "@/configs/utils";
...
const UserResume = (props: any) => {
    ...
    useEffect(() => {
        const init = async () => {
            setIsFetching(true);
            const res = (await callFetchResumeByUser()).data;
            if (res && res.data) {
...
const JobByEmail = (props: any) => {
    ...
    useEffect(() => {
        const init = async () => {
            await fetchSkill();
            const res = (await callGetSubscriberSkills()).data;
            if (res && res.data) {
    ...
    const fetchSkill = async () => {
        ...
        const res = (await callFetchAllSkill(query)).data;
        if (res && res.data) {
    ...
    const onFinish = async (values: any) => {
        ...
        if (!subscriber?.id) {
            ...
            const res = (await callCreateSubscriber(data)).data;
            if (res.data) {
                    ...
                    <Col span={24}>
                        ...
                        >
                            <Select
                                ...
                                placeholder={
                                    <>
                                        <MonitorOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} /> Tìm theo kỹ năng...
                                    </>
                                }
