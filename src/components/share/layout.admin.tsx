        ...
        if (permissions?.length || ACL_ENABLE === 'false') {
            ...
            const full = [
                ...
                ...(viewJob || ACL_ENABLE === 'false' ? [{
                    ...
                    key: '/admin/job',
                    icon: <ScheduleOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                }] : []),

                ...(viewResume || ACL_ENABLE === 'false' ? [{
                    label: <Link to='/admin/resume'>Resume</Link>,
                    key: '/admin/resume',
                    icon: <AliwangwangOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                }] : []),
                ...
                {!isMobile ?
                    <Sider
                        ...
                        <div style={{ height: 32, margin: 16, textAlign: 'center' }}>
                            <BugOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />  ADMIN
                        </div>
                        <Menu
