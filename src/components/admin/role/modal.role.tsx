...
import { callCreateRole, callFetchPermission, callUpdateRole } from "@/configs/api";
import { IPermission, IRole } from "@/types/backend";
import { CheckSquareOutlined } from "@ant-design/icons";
import ModuleApi from "./module.api";
import { useEffect } from 'react';
import { useAppDispatch, useAppSelector } from "@/redux/hooks";
import { resetSingleRole } from "@/redux/slices/roleSlide";
import { groupByPermission } from "@/configs/utils";
...
const ModalRole = (props: IProps) => {
    ...
    const submitRole = async (valuesForm: any) => {
        ...
        if (singleRole?.id) {
            ...
            const res = (await callUpdateRole(role, singleRole.id)).data;
            if (res.data) {
            ...
            const res = (await callCreateRole(role)).data;
            if (res.data) {
